...
1. **Earthquake Data**: Real-time / Historical data fetched directly from the **[USGS Search Earthquake Catalog API](https://earthquake.usgs.gov/fdsnws/event/1/)**. The dataset specifically captures events from **28 March 2025** (the date of the notable Mandalay earthquake) to the present day.
