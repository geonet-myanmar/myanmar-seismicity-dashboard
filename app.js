...
(function () {
    ...
    function setupFilterListeners() {
        ...
        magMin.addEventListener('change', applyFilters);
        magMax.addEventListener('change', applyFilters);
        ...
        depMin.addEventListener('change', applyFilters);
        depMax.addEventListener('change', applyFilters);
